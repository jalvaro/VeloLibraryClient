...
create table if not exists "favourite_stations" ("gid" INTEGER primary key autoincrement, "id" INTEGER, "name" TEXT, "position" INTEGER, "timestamp" TEXT DEFAULT CURRENT_TIMESTAMP);